...
<br clear="all" />
	...
	<tr>
		<td class="cat" colspan="2"><h4>Recent topics</h4></td>
	</tr>
	<tr>
		<td class="row1" align="center" valign="middle"><img src="<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/../imageset/forum_unread.gif" alt="Recent topics" /></td>
