...
*
* @package phpBB3
* @version $Id: thankslist.php,v 123 2009-06-11 10:02:51 Палыч$
...
switch ($mode)
{
	...
	$template_html = 'thankslist_body.html';
		...
		// Sorting
		$sort_key_text = array('a' => $user->lang['SORT_USERNAME'], 'b' => $user->lang['SORT_LOCATION'], 'c' => $user->lang['SORT_JOINED'], 'd' => $user->lang['SORT_POST_COUNT']);
